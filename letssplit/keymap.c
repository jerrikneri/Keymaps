...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_ortho_4x12( \
    ...
    KC_SPLT, KC_CAPP, _______, KC_SSL , KC_SSR , KC_LBRC, KC_RBRC, KC_4   , KC_5,  KC_6  , KC_PLUS, KC_PIPE, \
    _______, KC_PB  , KC_PF  , KC_SU  , KC_SD  , KC_LCBR, KC_RCBR, KC_1   , KC_2,  KC_3  , KC_MINS, _______, \
    KC_DEVT, _______, _______, _______, _______, _______, KC_DW  , _______, KC_0,  KC_DOT, _______, _______  \
  ),

  [_RAISE] = LAYOUT_ortho_4x12( \
    KC_GRV,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_PLUS, \
    _______, KC_GRV , _______, _______, KC_PGUP, KC_HOME, KC_EQL , KC_SF  , _______, KC_STL , KC_STR , KC_BSLS, \
    _______, _______, _______, _______, KC_PGDN, KC_END , KC_PLUS, _______, _______, KC_PB  , KC_PF  , _______, \
