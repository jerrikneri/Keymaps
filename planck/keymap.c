...
[_QWERTY] = LAYOUT_planck_grid(
  ...
  KC_GRV, KC_LCTL, KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_BSPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_RAISE] = LAYOUT_planck_grid(
  ...
  _______,  KC_MPRV, KC_MNXT, KC_VOLU, KC_PGUP, KC_HOME, KC_EQL,  KC_SF,  _______, KC_STL, KC_STR  , KC_BSLS,
  _______, KC_MSTP, KC_MPLY, KC_VOLD, KC_PGDN, KC_END,  KC_PLUS, _______, _______, KC_PB,  KC_PF   , _______,
